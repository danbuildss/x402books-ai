      ...
      <section className="settings-stack">
        <div className="content-card settings-card">
          ...
          <div className="setting-row">
            <div>
              <strong>Theme</strong>
              <p>Choose how x402Books appears.</p>
            </div>
          ...
          <div className="setting-row">
            <div>
              ...
              <p>Used across dashboard tables and reports.</p>
            </div>
        ...
        <div className="content-card settings-card">
          ...
          <div className="setting-row">
            <div>
              ...
              <p>Preferred file type for reports.</p>
            </div>
          ...
          <div className="setting-row">
            <div>
              <strong>Include Raw Data</strong>
              <p>Include raw transaction data in exports.</p>
            </div>
