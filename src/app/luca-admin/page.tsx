...
type Section = "overview" | "registry" | "attribution" | "economics" | "growth" | "reports" | "comm" | "outreach" | "settings" | "subagent-runs" | "pipeline-failures" | "pending-replies" | "truth-engine" | "pending-updates" | "attribution-health" | "address-classification" | "erc8004" | "revenue-audit" | "accuracy-report" | "confidence-labels" | "b20";
...
const NAV: { section: Section; label: string; group: string }[] = [
  ...
  { section: "pipeline-failures",  label: "Pipeline Failures", group: "intel" },
    ...
    <div className={styles.adminRoot}>
      ...
      <div className={styles.adminBody}>
        ...
        <main className={styles.workspace}>
          ...
          {section === "pipeline-failures" && <PipelineFailuresSection secret={secret} />}
