...
export default function HomePage() {
  ...
  "likely_x402_count": 128
      ...
      {/* ── Meet Luca ── */}
      <section className="lp-luca-section">
        <FadeContent delay={60}>
          <div className="lp-luca-inner">
            ...
            <p className="lp-luca-eyebrow">Meet Luca</p>
            <h2 className="lp-luca-headline">The first AI accountant<br />for the agent economy.</h2>
            <p className="lp-luca-sub">
              Send Luca a wallet address on Telegram. He audits it, categorizes every transaction,
              scores financial health, flags anomalies, and sends back a clean report — instantly.
            </p>
            <div className="lp-luca-caps">
              {["Wallet Audits", "Transaction Reports", "Agent Spend Review", "Anomaly Detection", "Financial Scoring"].map((cap) => (
            ...
            <p className="lp-luca-handle">@AskLucaBot · Named after Luca Pacioli, father of accounting</p>
          </div>
        </FadeContent>
      </section>
