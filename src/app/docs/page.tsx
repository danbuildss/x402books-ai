...
$LUCA      =  ecosystem asset (API tier, priority verification)`}</pre>
          ...
          <section id="how-it-works" className="docs-section">
            ...
            <p className="docs-p">Add this file to your repo at <code>.agent/wallets.json</code> (the legacy <code>.x402books/</code> path is still supported):</p>
            <div className="docs-code-block">
...
These are three distinct things. Never blur them.`}</pre>
            ...
            <p className="docs-p">
              The moat is the <strong>Agent Wallet Manifest standard</strong>. Any agent that adds <code>.agent/wallets.json</code> to their repo plugs into x402Books' verification pipeline, leaderboards, and badge system. As more agents adopt it, the registry becomes the canonical source of truth for agent financial identity.
            </p>
            <p className="docs-p">
