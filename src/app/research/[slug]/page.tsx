    ...
    <div className="lp-root">
      ...
      <article style={{ maxWidth: 720, margin: "0 auto", padding: "4rem 24px 6rem" }}>
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "center", margin: "16px 0 32px", fontSize: "0.8rem", color: "var(--muted)", flexWrap: "wrap" }}>
          ...
          <span>·</span>
          <span>x402Books Financial Intelligence</span>
          <span>·</span>
        ...
        <div style={{ marginTop: 48, paddingTop: 20, borderTop: "1px solid var(--line)", fontSize: "0.75rem", color: "var(--muted)", fontStyle: "italic", lineHeight: 1.6 }}>
          This report was generated by Luca, x402Books&rsquo; financial analyst, using on-chain data from declared wallet manifests. Only agents with attributed wallets are included. Numbers reflect confirmed on-chain activity only. This is not financial advice.
        </div>
